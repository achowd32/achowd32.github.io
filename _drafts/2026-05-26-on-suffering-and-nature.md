...
You might think that the ridicule levelled at this position is one of practicality. How are we supposed to eliminate predation? Do we kill all the predators? Doesn't that introduce more suffering??? Even if we desired such an outcome, how would we even manage achieve it?????
